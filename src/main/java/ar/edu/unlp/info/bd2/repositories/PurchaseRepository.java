...
public interface PurchaseRepository extends CrudRepository<Purchase, Long>{
	...
	public List<User> getUsersSpendingMoreThanInPurchase(@Param("amount") Float amount);
	
	@Query("SELECT cli "
			+ "FROM Purchase p join p.client as cli "
			+ "GROUP BY cli "
			+ "HAVING sum(p.amount) > :amount")
	public List<User> getUsersSpendingMoreThan(@Param("amount") Double amount);
	...
	public List<Provider> getTopNProvidersInPurchases(Pageable p);
